...
describe("renderKanbanBoard", () => {
  const issues: Issue[] = [
    issue({ ref: "a:1", key: "ENG-1", title: "First card", status: "todo", parent: { key: "ENG-100", title: "Epic One" }, labels: ["red-team"], customFields: { "Story Points": "3" }, assignee: "Jane Doe" }),
    issue({ ref: "a:2", key: "ENG-2", title: "Second card", status: "in_progress" }),
  ];
